...
interface HbaseIf {
  ...
  public function checkAndPut($tableName, $row, $column, $value, \Hbase\Mutation $mput, $attributes);
}
...
class HbaseClient implements \Hbase\HbaseIf {
  ...
  public function send_checkAndPut($tableName, $row, $column, $value, \Hbase\Mutation $mput, $attributes)
  {
